...
for (const item of coursesAndDurationArray) {
    ...
    course.innerText = `title: ${item.title}, monthDuration: ${item.monthDuration}`;
...
for (const item of coursesAndDurationArray) {
    ...
    course.append(h1, p);
    courses2.appendChild(course);
}
document.body.appendChild(courses2);
...
for (const simpson of simpsons) {
    ...
    member.append(h1, h2, p, img);
    simpsonsDiv.appendChild(member);
}
...
for (const item of coursesArray) {
    ...
    monthDuration.style.backgroundColor = 'lightblue';
    ...
    hourDuration.style.backgroundColor = 'lightgreen';
